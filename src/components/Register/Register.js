        ...
        <section className="register-page">
            ...
            >
                ...
                <div className="register-form__input-field">
                    ...
                    />
                    <span
                        className={`register-form__input-error register-form__input-error_active`}>
                ...
                <div className="register-form__input-field">
                    ...
                    <input
                        ...
                        required
                    />
                    <span className={`register-form__input-error ${isValid ? '' : 'register-form__input-error_active'
                        }`} >
                        {errors.password}
                    </span>
